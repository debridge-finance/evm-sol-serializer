...
library DlnClaimOrderUnlockBuilder {
    ...
    bytes32 private constant anchor_spl_token_ID = 0x06ddf6e1d765a193d9cbe146ceeb79ac1cb485ed5f5b37913a8cf5857eff00a9;

    // dln_src::GiveOrderState::WALLET_SEED = [71,73,86,69,95,79,82,68,69,82,95,87,65,76,76,69,84,]
    bytes17 private constant dln_src_GiveOrderState_WALLET_SEED = 0x474956455f4f524445525f57414c4c4554;

    // dln_src::AuthorizedNativeSender::SEED = [65,85,84,72,79,82,73,90,69,68,95,78,65,84,73,86,69,95,83,69,78,68,69,82]
    bytes24 private constant dln_src_AuthorizedNativeSender_SEED = 0x415554484f52495a45445f4e41544956455f53454e444552;
    ...
    function getClaimOrderUnlockExternalInstruction(
        ...
        return DeBridgeSolana.ExternalInstruction({
            ...
            pubkey_substitutions: getPubkeySubstitutionTuples(actionBeneficiary, orderId, orderTakeChainId, orderGiveTokenAddress),
    ...
    function getSerializedClaimOrderUnlockExternalInstruction(
        ...
        return getClaimOrderUnlockExternalInstruction(
    ...
    function getInstructionData(uint256 orderId) private pure returns (bytes memory) {
        return abi.encodePacked(
                    dln_unlock_discriminator,
                    orderId
                );
    }

    function getPubkeySubstitutionTuples(bytes32 actionBeneficiary, uint256 orderId, uint256 orderTakeChainId, bytes32 orderGiveTokenAddress) private pure returns (DeBridgeSolana.PubkeySubstitutionTuple[] memory pss) {
