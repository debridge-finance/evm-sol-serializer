...
contract HardcodedInstruction2Mock {
  ...
  function serializeNativeExternalInstruction2() external pure returns (bytes memory) {
    DeBridgeSolana.ExternalInstruction memory externalInstruction = DeBridgeSolana
      .ExternalInstruction({
        reward: 0,
        expense: 0,
  ...
  function getInstructionData() internal pure returns (bytes memory) {
    ...
    return
      abi.encodePacked(
        hex'5951b44f8e9042fbfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe'
      );
  }
  ...
  function getPubkeySubstitutionTuples()
    internal
    pure
    returns (DeBridgeSolana.PubkeySubstitutionTuple[] memory pss)
  {
    ...
    returns (DeBridgeSolana.PubkeySubstitutionTuple memory)
  {
    ...
    seeds[0] = DeBridgeSolanaPubkeySubstitutions.getArbitrarySeed(
      abi.encodePacked(hex'4645455f4c45444745525f57414c4c4554')
    );

    // [100; 32]
    seeds[1] = DeBridgeSolanaPubkeySubstitutions.getArbitrarySeed(
      abi.encodePacked(bytes32(0x6464646464646464646464646464646464646464646464646464646464646464))
    );
    ...
    returns (DeBridgeSolana.PubkeySubstitutionTuple memory)
  {
    ...
    seeds[1] = DeBridgeSolanaPubkeySubstitutions.getArbitrarySeed(
      abi.encodePacked(bytes32(0xfffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe))
    );
    ...
    returns (DeBridgeSolana.PubkeySubstitutionTuple memory)
  {
    ...
    // [200; 32]
    seeds[0] = DeBridgeSolanaPubkeySubstitutions.getArbitrarySeed(
      abi.encodePacked(bytes32(0xc8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8c8))
    );
    ...
    returns (DeBridgeSolana.PubkeySubstitutionTuple memory)
  {
    ...
    // [10; 32]
    seeds[1] = DeBridgeSolanaPubkeySubstitutions.getArbitrarySeed(
      abi.encodePacked(bytes32(0x0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A0A))
    );
  ...
  function getDataSubstitutions()
    internal
    pure
    returns (DeBridgeSolana.DataSubstitution[] memory)
  {}
